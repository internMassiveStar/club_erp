                    ...
                    <form class="form-valide" action="{{ url('/msp-form/club_fund') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <h6><b>Point</b></h6>
                                    <input style="border: .01px solid #969393;" type="number" class="form-control" placeholder="Special RCS point" name="member_special_rcs_point">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    <h6><b>Point</b></h6>
                                    <input style="border: .01px solid #969393;" type="number" class="form-control" placeholder="Donation point" name="member_donation_point">
                                </div>  
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    <h6><b>Point</b></h6>
                                    <input style="border: .01px solid #969393;" type="number" class="form-control" placeholder="  Member Investment point" name="member_investment_point">
                                </div>
                            </div>
